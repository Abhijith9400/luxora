    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 relative">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start justify-center space-x-0 lg:space-x-10 space-y-10 lg:space-y-0 px-5 py-20 w-full">
          ...
          <div className="bg-gray-800 text-white p-6 md:p-10 rounded-md shadow-md w-full max-w-[400px] md:max-w-[500px] lg:max-w-[1000px] h-auto m-5 relative lg:left-[-50px] lg:top-[200px] flex flex-col space-y-6 md:space-y-10">
            ...
            <div>
              ...
              <p className="text-gray-300">Mon - Fri: 10 am - 8 pm <br/>Sat, Sun: Closed</p>
            </div>
          </div>
        </div>
      </div>
